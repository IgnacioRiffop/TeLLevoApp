...
@Component({
  selector: 'app-viaje-seleccionado-p',
  templateUrl: './viaje-seleccionado-p.page.html',
  styleUrls: ['./viaje-seleccionado-p.page.scss'],
})
export class ViajeSeleccionadoPPage implements OnInit {
